const Movies = [
  {
    Title: "See",
    Description:
      "See: Created by Steven Knight. With Jason Momoa, Sylvia Hoeks, Hera Hilmar, Christian Camargo. ",
    Rating: 4,
    PosterURL:
  ...
  },
  {
    Title: "Breaking bad",
    Description:
      "Breaking Bad is an American neo-Western crime drama television series created and produced by Vince Gilligan. The show aired on AMC from January 20, 2008, ",
    Rating: 4,
    PosterURL:
